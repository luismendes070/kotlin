...
class MemberScopeTowerLevel(
    ...
    private fun FirCallableSymbol<*>.hasConsistentExtensionReceiver(extensionReceiver: List<ReceiverValue>): Boolean {
        return extensionReceiver.isNotEmpty() == hasExtensionReceiver()
    }
}
